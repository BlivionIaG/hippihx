...
#
# Default (V620): gfx1030, ROCm 7.14, wave32.
# Slots:          gfx1100, gfx900 — built as *separate* fatbins.
...
if(_hippihx_arch_count GREATER 1)
  message(FATAL_ERROR
    ...
    "hippihx ships three fatbins — configure one build tree per arch.")
endif()
...
if(_hippihx_arch_idx EQUAL -1)
  message(FATAL_ERROR
    "Unknown HIPPIHX_ARCH='${HIPPIHX_ARCH}'. Known slots: ${HIPPIHX_KNOWN_ARCHES}")
endif()
