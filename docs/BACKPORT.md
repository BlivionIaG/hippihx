...
sdot — skip. Draft **#16** resident MoE / TP4 serve — skip, not dest.
Foreign George + Codex. Do not dump. Do not copy tok/s. Closed **#11**
dest-reverted wvSplitK — **no zoo tile**. Closed **#12** superseded by
dest **#15**. Merged **#13/#14/#15** dest *presence*, observe, do not
...
| PR **#3** a17t / explore **#9/#10** sdot / closed **#12** / draft **#16** | **Skip.** Second W4 family, not dest, serve-only. **#12** superseded (folded into dest **#15**). **#16** resident MoE skinny + TP4 serve; gates default **off**. Dest `VLLM_RDNA_AR` still **0**. Do not dump. Do not copy tok/s. |
...
| extras draft **#16** resident MoE / TP4 serve | **Not taken** | Not dest. Foreign George + Codex. ATen HIP (`moe_resident_decode.cu`). Do not dump. Do not pick. Do not copy tok/s. |
