...
Open extras PRs **#2** (GLM Later), **#18** (a17t GPTQ
`BLOCK_KN_SIZE` 256 — skip, not dest DOT W4), and **#19** (a17t MTP
unquantized-weight detect — skip, MTP still not dest). Draft **#9/#10**
sdot — skip. Closed **#3** a17t WIP unmerged — skip, second W4 family.
Closed **#11** dest-reverted wvSplitK — **no zoo tile**. Closed **#12**
superseded by dest **#15**. Closed **#16** unmerged. Draft **#17**
resident MoE / TP4 serve — skip, not dest. Foreign George + Codex. Do
not dump. Do not copy tok/s. Merged **#13/#14/#15** dest *presence*,
...
| PR **#3** a17t / explore **#9/#10** sdot / closed **#12** / closed **#16** / draft **#17** / PR **#18** / PR **#19** | **Skip.** Second W4 family, not dest, serve-only. **#3** closed unmerged. **#12** superseded (folded into dest **#15**). **#16** unmerged. **#17** resident MoE skinny + eight-row tile + TP4 serve; extras GDN first-decode `zero_()` (dest already removed that wipe @ `388a61b6`). **#18** GPTQ exllama `BLOCK_KN_SIZE` 256 — extras vLLM path, not dest `w4a16_fdot2`. **#19** MTP unquantized-weight detect — Python only, MTP still not dest. Gates default **off**. Dest `VLLM_RDNA_AR` still **0**. Do not dump. Do not copy tok/s. |
...
| extras PR **#18** GPTQ `BLOCK_KN_SIZE` 256 | **Not taken** | Not dest. Foreign a17t / Simon Siebert. extras vLLM GPTQ exllama, not dest DOT W4. Do not dump. Do not pick. Do not copy tok/s. |
| extras PR **#19** MTP unquantized-weight detect | **Not taken** | Not dest. Foreign a17t / Simon Siebert. Python only (`qwen3_5_mtp.py`). MTP still not dest. Do not pick. Do not copy tok/s. |
...
| extras closed **#16** resident MoE / TP4 serve | **Not taken** | Closed unmerged. Not dest. Foreign George + Codex. Do not dump. Do not pick. Do not copy tok/s. |
| extras draft **#17** resident MoE / TP4 serve | **Not taken** | Not dest. Foreign George + Codex. ATen HIP (`moe_resident_decode.cu`, `moe_q_gemm_rdna2.cu`). Extras GDN first-decode `zero_()` is not dest. Do not dump. Do not pick. Do not copy tok/s. |
