...
| PR **#3** a17t / explore **#9/#10** sdot / closed **#12** / closed **#16** / draft **#17** / PR **#18** / PR **#19** | **Skip.** Second W4 family, not dest, serve-only. **#16** unmerged. **#17** resident MoE + extras GDN first-decode `zero_()` (dest already removed that wipe @ `388a61b6`). **#18** GPTQ `BLOCK_KN_SIZE` 256. **#19** MTP unquantized-weight detect. |
...
| extras not dest (**#16** closed / **#17** draft / **#18** / **#19**) | **Not taken** | Resident MoE, GPTQ `BLOCK_KN_SIZE` 256, MTP detect. extras GDN first-decode `zero_()` is not dest. |
